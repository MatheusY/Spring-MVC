	...
	<article id="${produto.id }">
		...
		<section class="buy-options clearfix">
			<form action="/carrinho/add" method="post" class="container">
				<input type="hidden" value="AQUI COLOQUE A ID DO PRODUTO"
					name="produtoId">
				<ul id="variants" class="clearfix">
					...
					<c:forEach items="${produto.precos }" var="preco">
						<li class="buy-option">
							...
							class="variant-radio" id="tipoPreco"
							value="${produto.tipo }" checked="checked" /> <label
				...
				<button type="submit" class="submit-image icon-basket-alt"
					title="Compre Agora AQUI '${produto.titulo }'"></button>
			</form>
		</section>
